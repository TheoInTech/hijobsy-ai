...
import { ClockCounterClockwise as SidebarIcon } from "@phosphor-icons/react";
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "flex justify-center items-center px-4 text-foreground hover:text-foreground/90 hover:bg-background/50",
        className
      )}
      onClick={(event) => {
        onClick?.(event);
      ...
      {...props}
    >
      <SidebarIcon size={24} className="transition-all text-foreground/80" />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn(
        "flex flex-col gap-2 p-4 text-lg font-semibold text-foreground",
        className
      )}
      {...props}
    />
